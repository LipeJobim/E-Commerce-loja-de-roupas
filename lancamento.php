...
<head>
    ...
    <title>Bella Boutique - Lançamentos</title>
...
<?php 
    ...
    // Consulta protegida
    $Consulta = $cn->prepare('SELECT * FROM vw_produto WHERE prod_lanc = :lanc');
    $Consulta->bindValue(':lanc', 'S');
    $Consulta->execute();
    $produtos = $Consulta->fetchAll(PDO::FETCH_ASSOC);
?>

<div class="container-fluid text-center">
    <h2 class="text-center" style="font-size:3.5vw; color:#000; text-shadow: 1px 1px 0 #fdeb00; text-transform: uppercase; letter-spacing: 5px;">
        Lançamentos
    </h2>
